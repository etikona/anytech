  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mt-4 w-2/4  text-xl bg-gradient-to-r from-purple-800  to-blue-800 p-2 rounded-full text-white font-bold text-center">
          AnyBaas BY AnyTech
        </p>
      </div>
      ...
      <div
        ref={waveRef}
        className="absolute inset-0 w-full h-full bg-gradient-to-r from-white to-pink-300"
      >
        <Image
          src={WaveLines4}
