    ...
    <div className="">
      ...
      >
        ...
        <div className="z-10 max-w-2xl text-left space-y-6">
          <p className=" font-bold text-blue-600 uppercase">OUR STORY</p>
          ...
          <p className="text-lg font-bold text-blue-950">
            ...
            enterprise committed to helping the global financial services
            industry reimagine banking and payment services.
          </p>
        </div>
